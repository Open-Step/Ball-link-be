package com.openstep.balllinkbe.features.export.service;
...
public class GamePdfService {

    private final TeamRecordRepository teamRecordRepository;

    public byte[] renderBoxscorePdf(Long gameId) {
        ...
        String xhtml = stripBomAndTrim(buildXhtml(dto, homeQ, awayQ, playerQ));
        ...
        try (ByteArrayOutputStream baos = new ByteArrayOutputStream()) {
            ...
            ClassPathResource regular = new ClassPathResource("fonts/NotoSansKR-Regular.ttf");
            ClassPathResource bold    = new ClassPathResource("fonts/NotoSansKR-Bold.ttf");

            if (regular.exists()) {
                builder.useFont(() -> {
                    try {
                        return regular.getInputStream();
                    } catch (IOException e) {
    ...
    /** XHTML (리바운드 합 + 출전시간 추가) */
    private String buildXhtml(GameBoxscoreResponse dto,
                              int[] homeQ, int[] awayQ,
        ...
        sb.append("""
            ...
            <style>
              ...
              *{font-family:'NotoSansKR',sans-serif;}
              ...
              .title{font-size:12px;color:#666;margin:2px 0 6px;}
        ...
        sb.append("<div class='title'>")
                .append(dto.getTournamentName() == null ? "" : escape(dto.getTournamentName()))
                .append(dateStr.isEmpty()? "" : " &#183; " + dateStr)
                .append(dto.getVenueName() == null ? "" : " &#183; " + escape(dto.getVenueName()))
                .append("</div>")
